 ...
 * Description: Custom table storage and REST submission layer for the Cowabunga waterpark game leaderboard. See DATABASE.md for the schema design.
 * Version: 1.0.0
 */
...
// drift check below.
define('WATERPARK_LEADERBOARD_ROUTES_VERSION', '1.3');
