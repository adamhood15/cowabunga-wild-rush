...
const SCREENS = [
  ...
  },
  {
    ...
    setup: `
      dismissLoader();
      byId("titlePanel").classList.remove("on");
      byId("namePanel").classList.add("on");
  ...
  },
  {
    ...
    postSetup: `
      ...
      overTextIn = true;
      byId("overPanel").classList.add("textIn", "riderIn");
      true
    `,
  ...
  },
  {
    ...
    setup: `
      ...
      byId("lbEmpty").classList.remove("on");
...
async function main() {
  ...
  try {
    ...
    process.exitCode = failures.length === 0 && pageExceptions.length === 0 ? 0 : 1; return;
  } finally {
