...
// for the new cowabunga-sprites/duck/duck_0N.png frames, off the real PNG
// alpha+color data via headless Chrome -- per AGENTS.md, "measure before
// coding," not guessed. Adapted from tools/eat-frame-measure.js: same teal
// ring detection (this art's ring is the same teal COWABUNGA tube used by
// the idle/eat/move sets, not the old typhoon rider's orange tube).
//
// Also measures the reference idle frame (cowabunga-idle_02.png) with the
// same probe, so index.html can pin the duck frames' tube width to IDLE's
...
//
// node tools/duck-frame-measure.js
